...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { cash_bonus: @level.cash_bonus, name: @level.name, share_bonus: @level.share_bonus } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { cash_bonus: @level.cash_bonus, name: @level.name, share_bonus: @level.share_bonus } }
